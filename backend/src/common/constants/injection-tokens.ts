...
export const CALL_INTERACTION_REPOSITORY = Symbol('CALL_INTERACTION_REPOSITORY');
export const DIALING_CONFIGURATION_REPOSITORY = Symbol('DIALING_CONFIGURATION_REPOSITORY');
