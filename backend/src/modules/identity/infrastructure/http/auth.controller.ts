...
export class AuthController {
  ...
  @HttpCode(HttpStatus.OK)
  @ApiOperation({
    summary: 'RF-1.03: Cambiar contraseña (usuario autenticado)',
  })
  ...
  @ApiOperation({
    summary: 'RF-1.04: Solicitar recuperación de contraseña (envía email)',
  })
  ...
  async forgotPassword(@Body() dto: RequestPasswordResetDto) {
    ...
    return {
      message:
        'Si el correo existe, se enviarán las instrucciones de recuperación.',
    };
  }
  ...
  @HttpCode(HttpStatus.OK)
  @ApiOperation({
    summary: 'RF-1.04: Completar restablecimiento de contraseña',
  })
